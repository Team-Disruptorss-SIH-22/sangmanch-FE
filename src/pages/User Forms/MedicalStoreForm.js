  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.userformContainer}>
        <div className={styles.detailsContainer}>
          ...
          <div className={styles.inputContainer}>
            <div className={styles.inputCol1}>
              <label htmlFor="uidai">Sold To (Aadhar No.)<span> *</span></label>
            </div>
            ...
            <div className={styles.inputCol1}>
              <label htmlFor="drlicense">Prescribed By (IMC ID)<span> *</span></label>
            </div>
            <div className={styles.inputCol2}>
              <input
                type="text"
        ...
        <div className={styles.detailsContainer}>
          <div className={styles.detailsHeader}>Drug Details<span> *</span></div>
          <p className={styles.detailsSubHeader}>
          ...
          <div className={styles.inputContainer}>
            <div className={styles.inputCol1}>
              <label htmlFor="quantity">Quantity Sold<span> *</span></label>
            </div>
            <div className={styles.inputCol2}>
              <input
                type="text"
            ...
            <div className={styles.inputCol1}>
              <label htmlFor="prescription">Upload Prescription<span> *</span></label>
            </div>
            <div className={styles.inputCol2}>
              <input
