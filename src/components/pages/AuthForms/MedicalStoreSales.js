      ...
      <div className={styles.loginPageContainer}>
        ...
        <form className={styles.formContainer} action="" onSubmit={handleSubmit}>
             ...
             <div className={styles.inputContainer}> 
                ...
                name="soldto" id="soldto" placeholder="Sold To (Aadhar No:)" />
            </div>
            ...
            <div className={styles.inputContainer}> 
                ...
                onChange={handleInput} 
                name="prescribedby" id="prescribedby" placeholder="Prescribed By (IMC ID)" />
            </div>       
            ...
            <div className={styles.inputContainer}> 
                ...
                onChange={handleInput} 
                name="quantitysold" id="quantitysold" placeholder="Quantity Sold" />
            </div>
